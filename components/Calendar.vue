          ...
          <div class="sim-calendar--aside--body">
            ...
            <div class="sim-flex--2">
              ...
              <div class="filter-molecule filter--instructors sim-filter">
                <h3 class="filter-molecule--heading"><SimIconText icon="#icon--instructors-checked" icon-type="svg" :text="instructorCountWithLabel"></SimIconText></h3>
...
<script>
  ...
  export default {
    ...
    computed: {
      instructorCountWithLabel() {
        return `Instructors: ${this.filterInstructorCount}`
      },
      currentDay() {
